...
class LNMORepository:
    ...
    def generate_password(self):
        ...
        """
        try:
            # Debugging: Print values before concatenation
            print(f"Short Code: {self.short_code}, Pass Key: {self.pass_key}, Timestamp: {self.timestamp}")

            # The password is generated by encoding the short code, pass key, and timestamp
            if None in (self.short_code, self.pass_key, self.timestamp):
